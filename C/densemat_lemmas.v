...
(** [end_densemat_in_frame] automatically converts a dense matrix back into an uninitialized array.
   (You would want to do this at the end of a block or the end of a function, so that when going
   [forward] through a [return] statement, VST-Floyd can pop the stack frame properly.)
   This tactic looks for an entailment with a densematn at address p in the precondition, and a matching
