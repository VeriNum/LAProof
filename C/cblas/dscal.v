...
Module Info.
  ...
  Definition source_file := "C/cblas/src/dscal.c".
...
Definition _cblas_dscal : ident := $"cblas_dscal".
...
Definition f_cblas_dscal := {|
  fn_return := tvoid;
  fn_callconv := cc_default;
  fn_params := ((_N, tint) :: (_alpha, tdouble) :: (_X, (tptr tdouble)) ::
                (_incX, tint) :: nil);
  fn_vars := nil;
  fn_temps := ((_i, tint) :: (_ix, tint) :: (_t'1, tdouble) :: nil);
  fn_body :=
(Ssequence
            ...
            (Ssequence
              ...
              (Sassign
                ...
                (Ebinop Omul (Etempvar _t'1 tdouble)
                  (Etempvar _alpha tdouble) tdouble)))
            (Sset _ix
              (Ebinop Oadd (Etempvar _ix tint) (Etempvar _incX tint) tint))))
        (Sset _i
...
((___compcert_va_int32,
 ...
 (___builtin_debug,
   Gfun(External (EF_external "__builtin_debug"
     ...
     (tint :: nil) tvoid
     {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|})) ::
 (_cblas_dscal, Gfun(Internal f_cblas_dscal)) :: nil).

Definition public_idents : list ident :=
(_cblas_dscal :: ___builtin_debug :: ___builtin_fmin :: ___builtin_fmax ::
