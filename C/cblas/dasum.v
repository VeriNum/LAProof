...
Module Info.
  ...
  Definition source_file := "C/cblas/src/dasum.c".
...
Definition _cblas_dasum : ident := $"cblas_dasum".
...
Definition f_cblas_dasum := {|
  fn_return := tdouble;
  fn_callconv := cc_default;
  fn_params := ((_N, tint) :: (_X, (tptr tdouble)) :: (_incX, tint) :: nil);
  fn_vars := nil;
  fn_temps := ((_r, tdouble) :: (_i, tint) :: (_ix, tint) ::
               (_t'1, tdouble) :: (_t'2, tdouble) :: nil);
  fn_body :=
(Ssequence
  ...
  (Ssequence
    ...
    (Ssequence
      (Sifthenelse (Ebinop Ole (Etempvar _incX tint)
...
((___compcert_va_int32,
 ...
 (_fabs,
   Gfun(External (EF_external "fabs"
                   (mksignature (AST.Xfloat :: nil) AST.Xfloat cc_default))
     (tdouble :: nil) tdouble cc_default)) ::
 (_cblas_dasum, Gfun(Internal f_cblas_dasum)) :: nil).

Definition public_idents : list ident :=
(_cblas_dasum :: _fabs :: ___builtin_debug :: ___builtin_fmin ::
