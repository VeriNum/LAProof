...
Module Info.
  ...
  Definition source_file := "C/src/cholesky.c".
...
Definition _cholesky : ident := $"cholesky".
...
Definition f_cholesky := {|
  fn_return := tvoid;
  fn_callconv := cc_default;
  fn_params := ((_n, tuint) :: (_A, (tptr (tarray tdouble 1000))) ::
                (_R, (tptr (tarray tdouble 1000))) :: nil);
  fn_vars := nil;
  fn_temps := ((_i, tuint) :: (_j, tuint) :: (_k, tuint) :: (_s, tdouble) ::
               (_rkj, tdouble) :: (_t'1, tdouble) :: (_t'4, tdouble) ::
               (_t'3, tdouble) :: (_t'2, tdouble) :: nil);
  fn_body :=
(Ssequence
  (Sset _j (Econst_int (Int.repr 0) tint))
  (Sloop
    (Ssequence
      (Sifthenelse (Ebinop Olt (Etempvar _j tuint) (Etempvar _n tuint) tint)
        Sskip
        Sbreak)
      (Ssequence
        (Ssequence
                ...
                (Sset _s
                  (Ederef
                    (Ebinop Oadd
                      (Ederef
                        (Ebinop Oadd
                          (Etempvar _A (tptr (tarray tdouble 1000)))
                          (Etempvar _i tuint) (tptr (tarray tdouble 1000)))
                        (tarray tdouble 1000)) (Etempvar _j tuint)
                          ...
                          (Sset _t'3
                            (Ederef
                              (Ebinop Oadd
                                (Ederef
                                  (Ebinop Oadd
                                    (Etempvar _R (tptr (tarray tdouble 1000)))
                                    (Etempvar _k tuint)
                                    (tptr (tarray tdouble 1000)))
                                  (tarray tdouble 1000)) (Etempvar _i tuint)
                                (tptr tdouble)) tdouble))
                          (Ssequence
                            (Sset _t'4
                              (Ederef
        ...
        (Ssequence
          (Sset _s
            (Ederef
              (Ebinop Oadd
                (Ederef
                  (Ebinop Oadd (Etempvar _A (tptr (tarray tdouble 1000)))
                    (Etempvar _j tuint) (tptr (tarray tdouble 1000)))
                  (tarray tdouble 1000)) (Etempvar _j tuint) (tptr tdouble))
              tdouble))
          (Ssequence
            (Ssequence
              (Sset _k (Econst_int (Int.repr 0) tint))
            ...
            (Ssequence
              (Scall (Some _t'1)
                (Evar _sqrt (Tfunction (Tcons tdouble Tnil) tdouble
                              cc_default)) ((Etempvar _s tdouble) :: nil))
              (Sassign
                (Ederef
                  (Ebinop Oadd
                    (Ederef
                      (Ebinop Oadd (Etempvar _R (tptr (tarray tdouble 1000)))
                        (Etempvar _j tuint) (tptr (tarray tdouble 1000)))
                      (tarray tdouble 1000)) (Etempvar _j tuint)
                    (tptr tdouble)) tdouble) (Etempvar _t'1 tdouble)))))))
    (Sset _j
      (Ebinop Oadd (Etempvar _j tuint) (Econst_int (Int.repr 1) tint) tuint))))
|}.
...
((___compcert_va_int32,
 ...
 (_sqrt,
   Gfun(External (EF_external "sqrt"
                   (mksignature (AST.Tfloat :: nil) AST.Tfloat cc_default))
     (Tcons tdouble Tnil) tdouble cc_default)) ::
 (_cholesky, Gfun(Internal f_cholesky)) :: nil).

Definition public_idents : list ident :=
(_cholesky :: _sqrt :: ___builtin_debug :: ___builtin_fmin ::
